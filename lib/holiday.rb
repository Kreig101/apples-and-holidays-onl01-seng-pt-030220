...
def add_supply_to_winter_holidays(holiday_hash, supply)
  ...
  # holiday_hash.each do  |seson, holiday|
...
def add_new_holiday_with_supplies(holiday_hash, season, holiday_name, supply_array)
  ...
  # 1) holiday_supplies_hash #add_new_holiday_with_supplies modifies the originalhash by adding supplies of a new holiday to a season
...
def all_holidays_with_bbq(hash)
  ...
  # include the string "BBQ"
    ...
    hash.map do |season, holiday_hash|
